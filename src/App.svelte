...
<main>
  <header>
    <div class="header-content">
      <div class="logo-container">
        <svg class="app-logo" width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-right: 8px; vertical-align: middle;">
          <circle cx="16" cy="16" r="14" stroke="#3498DB" stroke-width="2.5" />
          <path d="M16 8V16L22 20" stroke="#3498DB" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
        </svg>
        <h1>Pomodoro Tracker</h1>
      </div>
...
<svg class="app-logo" width="24" height="24" viewBox="0 0 32 32" fill="none" xmlns="http://www.w3.org/2000/svg" style="margin-right: 8px;">
  <circle cx="16" cy="16" r="14" stroke="#3498DB" stroke-width="2.5" />
  <path d="M16 8V16L22 20" stroke="#3498DB" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round" />
</svg>
Pomodoro Tracker
